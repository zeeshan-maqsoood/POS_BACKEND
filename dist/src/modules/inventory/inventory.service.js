...
exports.supplierService = exports.inventoryItemService = exports.inventorySubcategoryService = exports.inventoryCategoryService = void 0;
...
exports.inventorySubcategoryService = {
    async create(data, user) {
...
exports.supplierService = {
    ...
    async addProductToSupplier(supplierId, inventoryItemId, supplierProductData, user) {
        // First verify the supplier exists
        const supplier = await prisma.supplier.findUnique({
            where: { id: supplierId }
        });
    ...
    async getSupplierProducts(supplierId, user) {
        const supplier = await prisma.supplier.findUnique({
            where: { id: supplierId },
            include: {
                products: {
    ...
    async updateSupplierProduct(supplierProductId, data, user) {
    ...
    async removeSupplierProduct(supplierProductId, user) {
        const existing = await prisma.supplierProduct.findUnique({
            where: { id: supplierProductId }
        });
        if (!existing) {
