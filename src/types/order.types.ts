...
export interface OrderItem {
  ...
  total: number;
  notes?: string | null;
  modifiers?: any; // You might want to type this more specifically based on your needs
  orderId?: string;
  menuItem?: any; // You can type this more specifically based on your needs
  createdAt?: Date;
  updatedAt?: Date;
}
...
export interface UpdateOrderInput {
  ...
  items?: OrderItemInput[];
  branchName?: string;
  [key: string]: any; // Allow other fields that might be needed
}