...
-- CreateEnum
CREATE TYPE "public"."Permission" AS ENUM ('USER_CREATE', 'USER_READ', 'USER_UPDATE', 'USER_DELETE', 'MANAGER_CREATE', 'MANAGER_READ', 'MANAGER_UPDATE', 'RESTAURANT_CREATE', 'RESTAURANT_READ', 'RESTAURANT_UPDATE', 'RESTAURANT_DELETE', 'RESTAURANT_BRANCH_MANAGE', 'ORDER_CREATE', 'ORDER_READ', 'ORDER_UPDATE', 'ORDER_DELETE', 'POS_CREATE', 'POS_READ', 'POS_UPDATE', 'POS_DELETE', 'PRODUCT_CREATE', 'PRODUCT_READ', 'PRODUCT_UPDATE', 'PRODUCT_DELETE', 'MENU_CREATE', 'MENU_READ', 'MENU_UPDATE', 'MENU_DELETE', 'SUPPLIER_CREATE', 'SUPPLIER_READ', 'SUPPLIER_UPDATE', 'SUPPLIER_DELETE', 'PURCHASE_ORDER_CREATE', 'PURCHASE_ORDER_READ', 'PURCHASE_ORDER_UPDATE', 'PURCHASE_ORDER_DELETE', 'DASHBOARD_READ');

-- CreateEnum
CREATE TYPE "public"."OrderStatus" AS ENUM ('PENDING', 'PROCESSING', 'CONFIRMED', 'PREPARING', 'READY_FOR_PICKUP', 'COMPLETED', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "Order_branchName_idx" ON "public"."Order"("branchName");
...
-- CreateIndex
CREATE UNIQUE INDEX "MenuItemModifier_menuItemId_modifierId_restaurantId_branchI_key" ON "public"."MenuItemModifier"("menuItemId", "modifierId", "restaurantId", "branchId");
...
-- AddForeignKey
ALTER TABLE "public"."modifiers" ADD CONSTRAINT "modifiers_restaurantId_fkey" FOREIGN KEY ("restaurantId") REFERENCES "public"."Restaurant"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."modifiers" ADD CONSTRAINT "modifiers_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "public"."Branch"("id") ON DELETE SET NULL ON UPDATE CASCADE;
